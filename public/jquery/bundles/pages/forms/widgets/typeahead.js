...
var KTTypeahead = function() {
    ...
    var demo1 = function() {
        ...
        $('#dunnio_typeahead_1, #dunnio_typeahead_1_modal, #dunnio_typeahead_1_validate, #dunnio_typeahead_2_validate, #dunnio_typeahead_3_validate').typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        }, {
    ...
    var demo2 = function() {
        ...
        $('#dunnio_typeahead_2, #dunnio_typeahead_2_modal').typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        },
    ...
    var demo3 = function() {
        ...
        // options being used
        $('#dunnio_typeahead_3, #dunnio_typeahead_3_modal').typeahead(null, {
            name: 'countries',
            source: countries
        });
    }
    ...
    var demo4 = function() {
        ...
        $('#dunnio_typeahead_4').typeahead(null, {
            name: 'best-pictures',
            display: 'value',
            source: bestPictures,
            templates: {
